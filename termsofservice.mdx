...
<Warning>
  Breaking any of these terms of service gives Juze.dev and all his associates access to decline giving support and can result in your license resource(s) being revoked.
</Warning>

1. Reselling any offical Juze.dev asset without correct authorization.
2. Purposely attempting to promote any Juze.dev asset in a negative and/or malicious way.
3. Attempting to leak, crack, decrypt, or view any decrypted code.
4. Attempting to abuse any Juze.dev asset’s features, such as discord logs.
